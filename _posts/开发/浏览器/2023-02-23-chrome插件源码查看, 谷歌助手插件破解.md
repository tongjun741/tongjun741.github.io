...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
    ...
    e.installNotification = function() {
        ...
        $.getJSON(n.info.rootServer + "getNotifications", function(t) {
            ...
            t["version-message"] && t["version-message"][e] && (localStorage["popup-message"] = t["version-message"][e]), localStorage.NotificationsNum = t["install-notifications"].time, t["install-notifications"].message && "" != t["install-notifications"].message && setTimeout(function() {
    ...
    e.get = function(t, e) {
        ...
        s(i, 0, function(r) {
            ...
            o(u, 0, function(e) {
                ...
                n.info.rootServer = localStorage.rootServer = e + "app/ext/", t()
    ...
    var l = function(t) {
            ...
            e.vn > 0 && parseInt(localStorage.mversion) != e.vn ? $.ajax({
                ...
                success: function(t) {
                    ...
                    2 == o.length ? n.IO.W("rml", o[0], function() {

                        n.IO.W("cml", o[0], function() {

                            console.log("update!"), localStorage.mversion = e.vn
    ...
    o.off("...", "正在连接主服务器,请等待10秒"), a.get(function() {

        n.D(), n.R(function() {

            localStorage["auto-homepage"] && "true" == localStorage["auto-homepage"] && chrome.tabs.query({}, function(t) {

                for (var e = !1, n = 0; n < t.length; n++) if ("chrome://newtab/" == t[n].url) {
            ...
            i.installNotification(), n.A(function(t) {

                o.on(), r.I(t), n.U(), window.setTimeout(function() {
                ...
                console.error("apply fail:" + t.error), badge.off("!", "错误：申请试用失败"), n.U()
    ...
    t.push(["_setAccount", "UA-48334954-3"]), t.push(["_trackPageview"]), function() {
...
![](../../_resources/5433f6ed0757401d89efe4b8319daf15.png)
...
链接：https://www.jianshu.com/p/34d005507a0f
